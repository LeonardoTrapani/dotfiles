---
description: convert a prd to prd.jsonc for ralph
---

# Ralph PRD Converter

Converts existing PRDs to the prd.jsonc format that Ralph uses for autonomous execution.

---

## The Job

Take a PRD (markdown file or text) and convert it to `prd.jsonc` in the current directory.
