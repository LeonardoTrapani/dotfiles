...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  group = vim.api.nvim_create_augroup('leotrapani-highlight-yank', { clear = true }),
  callback = function()
    vim.hl.on_yank()
  end,
})
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        group = vim.api.nvim_create_augroup('leotrapani-lsp-attach', { clear = true }),
        callback = function(event)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
            local highlight_augroup = vim.api.nvim_create_augroup('leotrapani-lsp-highlight', { clear = false })
            ...
            vim.api.nvim_create_autocmd('LspDetach', {
              group = vim.api.nvim_create_augroup('leotrapani-lsp-detach', { clear = true }),
              callback = function(event2)
                vim.lsp.buf.clear_references()
                vim.api.nvim_clear_autocmds { group = 'leotrapani-lsp-highlight', buffer = event2.buf }
              end,
            })
          end
  ...
  -- The following comments only work if you have downloaded the leotrapani repo, not just copy pasted the
  ...
  --
  require 'leotrapani.plugins.debug',
  -- require 'leotrapani.plugins.indent_line',
  require 'leotrapani.plugins.lint',
  require 'leotrapani.plugins.autopairs',
  ...
  { import = 'plugins' }, -- omarchy theme switching
  --
...
-- Transparency (must run after colorscheme loads)
